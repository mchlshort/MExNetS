...
class HybridStrategy(object):
    ...
    def run_hybrid_strategy(self, max_iter=None, cor_filter_size=None):
        ...
        Args:
            ...
            cor_filter_size (int, optional): default = 10000. User should input small number (0.02). 
        ...
        Ex1MEN = MENS(rich_data=Rich_data,lean_data=Lean_data, correction_factors = None, parameter_data=problem_parameters, stream_properties = stream_properties)
                ...
                for j in MENS_solved.j:
                    for k in MENS_solved.k:
                        ...
                        if MENS_solved.y[i,j,k].value==1 and MENS_solved.M[i,j,k].value!=0:
                            ...
                            ME5, ME5results, presolve_5 = mx.Construct_pyomo_model_5(ME4, success4, presolve_4)
                            print(ME5results)
        ...
        print("Optimal solution for NLP: ", self.best_objective_real) 
        return print("Hopefully the optimal solution is somewhere in the jumbled mess above")
...
Example1.run_hybrid_strategy(cor_filter_size=0.05, max_iter=50)
