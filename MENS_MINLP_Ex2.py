...
class MENS(object):
    ...
    def NLP_MENS_init(self, correction_factors=None):
        ...
        """
        print("THIS IS THE START OF THE NLP INITIALIZATION for the MINLP")
        if correction_factors == None:
            print("No correction factors provided, so all assumed to equal 1")
        ...
        model.arex = {}
        model.arex['R1','L1',1] = 0
        model.arex['R1','L2',1] = 0
        model.arex['R1','L3',1] = 0
        
        model.arex['R2','L1',1] = 0
        model.arex['R2','L2',1] = 0
        model.arex['R2','L3',1] = 0
        
        model.arex['R3','L1',1] = 1
        model.arex['R3','L2',1] = 1
        model.arex['R3','L3',1] = 1
        
        model.arex['R4','L1',1] = 0
        model.arex['R4','L2',1] = 0
        model.arex['R4','L3',1] = 0
        
        model.arex['R5','L1',1] = 0
        model.arex['R5','L2',1] = 0
        model.arex['R5','L3',1] = 0
        
        
        model.arex['R1','L1',2] = 0
        model.arex['R1','L2',2] = 0
        model.arex['R1','L3',2] = 0
        
        model.arex['R2','L1',2] = 0
        model.arex['R2','L2',2] = 0
        model.arex['R2','L3',2] = 0
        
        model.arex['R3','L1',2] = 1
        model.arex['R3','L2',2] = 1
        model.arex['R3','L3',2] = 1
        
        model.arex['R4','L1',2] = 1
        model.arex['R4','L2',2] = 1
        model.arex['R4','L3',2] = 1
        
        model.arex['R5','L1',2] = 0
        model.arex['R5','L2',2] = 0
        model.arex['R5','L3',2] = 0
        
        
        model.arex['R1','L1',3] = 0
        model.arex['R1','L2',3] = 0
        model.arex['R1','L3',3] = 0
        
        model.arex['R2','L1',3] = 0
        model.arex['R2','L2',3] = 0
        model.arex['R2','L3',3] = 0
        
        model.arex['R3','L1',3] = 1
        model.arex['R3','L2',3] = 1
        model.arex['R3','L3',3] = 1
        
        model.arex['R4','L1',3] = 1
        model.arex['R4','L2',3] = 1
        model.arex['R4','L3',3] = 1
        
        model.arex['R5','L1',3] = 1
        model.arex['R5','L2',3] = 1
        model.arex['R5','L3',3] = 1
        
        
        model.arex['R1','L1',4] = 1
        model.arex['R1','L2',4] = 1
        model.arex['R1','L3',4] = 1
        
        model.arex['R2','L1',4] = 1
        model.arex['R2','L2',4] = 1
        model.arex['R2','L3',4] = 1
        
        model.arex['R3','L1',4] = 1
        model.arex['R3','L2',4] = 1
        model.arex['R3','L3',4] = 1
        
        model.arex['R4','L1',4] = 1
        model.arex['R4','L2',4] = 1
        model.arex['R4','L3',4] = 1
        
        model.arex['R5','L1',4] = 1
        model.arex['R5','L2',4] = 1
        model.arex['R5','L3',4] = 1
        
        
        model.arex['R1','L1',5] = 1
        model.arex['R1','L2',5] = 0
        model.arex['R1','L3',5] = 1
        
        model.arex['R2','L1',5] = 1
        model.arex['R2','L2',5] = 0
        model.arex['R2','L3',5] = 1
        
        model.arex['R3','L1',5] = 1
        model.arex['R3','L2',5] = 0
        model.arex['R3','L3',5] = 1
        
        model.arex['R4','L1',5] = 1
        model.arex['R4','L2',5] = 0
        model.arex['R4','L3',5] = 1
        
        model.arex['R5','L1',5] = 1
        model.arex['R5','L2',5] = 0
        model.arex['R5','L3',5] = 1
        
        
        model.arex['R1','L1',6] = 0
        model.arex['R1','L2',6] = 0
        model.arex['R1','L3',6] = 1
        
        model.arex['R2','L1',6] = 0
        model.arex['R2','L2',6] = 0
        model.arex['R2','L3',6] = 1
        
        model.arex['R3','L1',6] = 0
        model.arex['R3','L2',6] = 0
        model.arex['R3','L3',6] = 1
        
        model.arex['R4','L1',6] = 0
        model.arex['R4','L2',6] = 0
        model.arex['R4','L3',6] = 1
        
        model.arex['R5','L1',6] = 0
        model.arex['R5','L2',6] = 0
        model.arex['R5','L3',6] = 1


        model.arex['R1','L1',7] = 0
        model.arex['R1','L2',7] = 0
        model.arex['R1','L3',7] = 0
        
        model.arex['R2','L1',7] = 0
        model.arex['R2','L2',7] = 0
        model.arex['R2','L3',7] = 0
        
        model.arex['R3','L1',7] = 0
        model.arex['R3','L2',7] = 0
        model.arex['R3','L3',7] = 0
        
        model.arex['R4','L1',7] = 0
        model.arex['R4','L2',7] = 0
        model.arex['R4','L3',7] = 0
        
        model.arex['R5','L1',7] = 0
        model.arex['R5','L2',7] = 0
        model.arex['R5','L3',7] = 0
        ...
        model.avlean = Var(model.j, initialize=0.9, within=NonNegativeReals)
        ...
        model.ckr_first = Param(model.i,model.k,initialize = 1000,mutable=True)
        model.ckr_first['R3',1]=model.ck[1]
        model.ckr_first['R4',2]=model.ck[2]
        model.ckr_first['R5',3]=model.ck[3]
        model.ckr_first['R1',4]=model.ck[4]
        model.ckr_first['R2',4]=model.ck[4]
        
        model.ckl_first = Param(model.j,model.k,initialize = 1000,mutable=True)
        model.ckl_first['L2',5] = model.ck[5]
        model.ckl_first['L1',6] = model.ck[6]
        model.ckl_first['L3',7] = model.ck[7]
        #model.ckr_first.pprint()
        #model.ckl_first.pprint()

        model.r_exist = Param(model.i,model.k,initialize = 0.0,mutable=True)

        model.r_exist['R1',1]=0
        model.r_exist['R1',2]=0
        model.r_exist['R1',3]=0
        model.r_exist['R1',4]=1
        model.r_exist['R1',5]=1
        model.r_exist['R1',6]=1
        model.r_exist['R1',7]=0

        model.r_exist['R2',1]=0
        model.r_exist['R2',2]=0
        model.r_exist['R2',3]=0
        model.r_exist['R2',4]=1
        model.r_exist['R2',5]=1
        model.r_exist['R2',6]=1
        model.r_exist['R2',7]=0
        
        model.r_exist['R3',1]=1
        model.r_exist['R3',2]=1
        model.r_exist['R3',3]=1
        model.r_exist['R3',4]=1
        model.r_exist['R3',5]=1
        model.r_exist['R3',6]=1
        model.r_exist['R3',7]=0
        
        model.r_exist['R4',1]=0
        model.r_exist['R4',2]=1
        model.r_exist['R4',3]=1
        model.r_exist['R4',4]=1
        model.r_exist['R4',5]=1
        model.r_exist['R4',6]=1
        model.r_exist['R4',7]=0
        
        model.r_exist['R5',1]=0
        model.r_exist['R5',2]=0
        model.r_exist['R5',3]=1
        model.r_exist['R5',4]=1
        model.r_exist['R5',5]=1
        model.r_exist['R5',6]=1
        model.r_exist['R5',7]=0
        ...
        model.l_exist['L1',3]=1
        model.l_exist['L1',4]=1
        model.l_exist['L1',5]=1
        model.l_exist['L1',6]=0
        model.l_exist['L1',7]=0

        model.l_exist['L2',1]=1
        model.l_exist['L2',2]=1
        model.l_exist['L2',3]=1
        model.l_exist['L2',4]=1
        model.l_exist['L2',5]=0
        model.l_exist['L2',6]=0
        model.l_exist['L2',7]=0
        
        model.l_exist['L3',1]=1
        model.l_exist['L3',2]=1
        model.l_exist['L3',3]=1
        model.l_exist['L3',4]=1
        model.l_exist['L3',5]=1
        model.l_exist['L3',6]=1
        model.l_exist['L3',7]=0
        #==================================================================================
        #   CONSTRAINTS
        #==================================================================================
        #===============================================================================
