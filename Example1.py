...
from HybridStrategy_Ex1 import *
...
example_name = 'Example1_0.01filt150ittol0.01'
...
Example1.run_hybrid_strategy(cor_filter_size=0.01, max_iter=150,rich_data=Rich_data,lean_data=Lean_data, correction_factors = None, parameter_data=problem_parameters, stream_properties = stream_properties, exname = example_name, tol = 0.01)
