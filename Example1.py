...
example_name = 'conoptpackExample1_0.02filt200ittol0.005'
...
Example1.run_hybrid_strategy(cor_filter_size=0.02, max_iter=4,rich_data=Rich_data,lean_data=Lean_data, correction_factors = None, parameter_data=problem_parameters, stream_properties = stream_properties, exname = example_name, tol = 0.0002)
